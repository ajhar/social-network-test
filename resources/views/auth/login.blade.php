            ...
            <div class="col-lg-12">
                <div class="text-center mb-5">
                    <a href="index.html" class="logo">
                        <img src={{asset("assets/images/logo-light.png")}} height="24" alt="logo"></a>
                    <h5 class="font-size-16 text-white-50 mb-4">{{__('Ed-Tech Rostering App')}}</h5>
                </div>
            </div>
        </div>
        <!-- end row -->
                                                ...
                                                <div class="col-md-6">
                                                    <div class="text-md-right mt-3 mt-md-0">
                                                        <a href="{{ route('password.request') }}" class="text-muted"><i
                                                                class="mdi mdi-lock"></i>{{ __('Forgot your password?') }}
                                                        </a>
                                                    </div>
                                                </div>
                                            @endif
